package com.sn.librarymanagement.config;
...
@Configuration
@ComponentScan(basePackages={"com.sn.librarymanagement.model"})
@EnableTransactionManagement
public class HibernateConfig {

	
	private final static String DATABASE_URL = "jdbc:postgresql://localhost:5432/librarymanagement";
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.sn.librarymanagement.model");
